// Legacy SecurityManager - Compatibility layer
// This file maintains backward compatibility while using the new modular security system

export { SecurityManager as SecurityManagerV2 } from './security/securityManager';

// Import the new types for compatibility
import type { SecurityConfig, ValidationResult } from './security/types';
import { SecurityManager } from './security/securityManager';

/**
 * @deprecated Use SecurityManager from './security/securityManager' instead
 * This is a compatibility layer that forwards to the new modular system
 */
