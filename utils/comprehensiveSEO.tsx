...
interface ComprehensiveSEOProps {
  ...
  isBasedOn?: string | Record<string, unknown>;
  translationOfWork?: string | Record<string, unknown>;
  workTranslation?: string | Record<string, unknown>;
  exampleOfWork?: string | Record<string, unknown>;
  workExample?: string | Record<string, unknown>;
  genre?: string[];
  schemaKeywords?: string[];
  position?: string;
  awards?: string[];
  contentLocation?: Record<string, unknown>;
  contentReferenceTime?: string;
  spatialCoverage?: Record<string, unknown>;
  temporalCoverage?: string;
  audience?: Record<string, unknown>;
  educationalUse?: string;
  learningResourceType?: string;
  teaches?: string[];
  assessedBy?: Record<string, unknown>;
  ...
  schemaOffers?: Record<string, unknown>;
  requiresSubscription?: boolean;
  isAccessibleForFree?: boolean;
  thumbnailUrl?: string;
  image?: string | Array<Record<string, unknown>>;
  provider?: Record<string, unknown>;
  publisher?: Record<string, unknown>;
  sourceOrganization?: Record<string, unknown>;
  ...
  musicBy?: Record<string, unknown>;
  creator?: Record<string, unknown>;
  contributor?: Record<string, unknown>;
  editor?: Record<string, unknown>;
  illustrator?: Record<string, unknown>;
  colorist?: Record<string, unknown>;
  inker?: Record<string, unknown>;
  letterer?: Record<string, unknown>;
  penciler?: Record<string, unknown>;
  review?: Record<string, unknown>;
  schemaAggregateRating?: Record<string, unknown>;
  schemaOffers2?: Record<string, unknown>;
  size?: string;
  material?: string;
  weight?: string;
  color?: string;
  ...
  variesBy?: Array<Record<string, unknown>>;
  hasVariant?: Array<Record<string, unknown>>;
  isVariantOf?: Record<string, unknown>;
  prequel?: Record<string, unknown>;
  sequel?: Record<string, unknown>;
  followUp?: Record<string, unknown>;
  previousItem?: Record<string, unknown>;
  nextItem?: Record<string, unknown>;
  mainEntity?: Record<string, unknown>;
  schemaMentions?: Array<Record<string, unknown>>;
  comment?: Array<Record<string, unknown>>;
  commentCount?: number;
  interactionStatistic?: Array<Record<string, unknown>>;
  schemaIsPartOf?: Record<string, unknown>;
