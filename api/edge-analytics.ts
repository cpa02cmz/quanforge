...
// Removed for production: console.error('Analytics processing error:', error);
        return new Response(JSON.stringify({
          success: false,
...
// Removed for production: console.error('Analytics summary error:', error);
        return new Response(JSON.stringify({
          success: false,
...
// Removed for production: console.error('Performance score error:', error);
        return new Response(JSON.stringify({
          success: false,
...
// Removed for production: console.error('Streaming error:', error);
                const errorMessage = {
                  type: 'error',
...
// Removed for production: console.error('Streaming setup error:', error);
        return new Response(JSON.stringify({
          success: false,
...
// Removed for production: console.error('Aggregation error:', error);
        return new Response(JSON.stringify({
          success: false,
...
// Removed for production: console.error('Simulation error:', error);
        return new Response(JSON.stringify({
          success: false,
...
// Removed for production: console.error('Edge analytics function error:', error);
    return new Response(JSON.stringify({
      success: false,
...
// Removed for production: console.error(`Failed to send to stream ${clientId}:`, error);
      streamingConnections.delete(clientId);
    }
  }
}
...
// Removed for production: console.log(`Cleaned up ${staleConnections.length} stale streaming connections`);
  }
