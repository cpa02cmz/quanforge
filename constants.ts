...
export const SUGGESTED_STRATEGIES: Record<Language, { label: string; prompt: string }[]> = {
  en: [
  ...
  id: [
    { label: 'Pembalikan RSI', prompt: 'Buat strategi Mean Reversion menggunakan RSI(14). Buy saat RSI < 30, Sell saat RSI > 70.' },
    { label: 'Tren MACD', prompt: 'Buat strategi Trend Following menggunakan MACD. Buy saat garis MACD memotong ke atas garis Signal, Sell saat memotong ke bawah.' },
    { label: 'Breakout Bollinger', prompt: 'Buat strategi Breakout. Buy saat harga close di atas Upper Bollinger Band, Sell saat di bawah Lower Band.' },
    { label: 'Korelasi Emas', prompt: 'Buat strategi untuk BTCUSD. Buy hanya jika Emas (XAUUSD) sedang tren naik (Harga > EMA 200 di H1).' }
  ]
};
